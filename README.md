...
This project is part of the FreeCodeCamp [Frontend Libraries Projects](https://learn.freecodecamp.org/front-end-libraries/front-end-libraries-projects/build-a-javascript-calculator/), and follows a series of requested user stories. As this is currently in progress, there are a few cases that are yet to be covered by the tests.
